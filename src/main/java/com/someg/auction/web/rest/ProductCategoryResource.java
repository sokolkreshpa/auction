...
/**
 * REST controller for managing {@link com.someg.auction.domain.ProductCategory}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<ProductCategory> result = productCategoryRepository
            ...
            .map(existingProductCategory -> {
                if (productCategory.getCategoryDescription() != null) {
                    existingProductCategory.setCategoryDescription(productCategory.getCategoryDescription());
                }
