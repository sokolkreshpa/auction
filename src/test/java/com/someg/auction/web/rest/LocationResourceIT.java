...
import com.someg.auction.domain.Location;
import com.someg.auction.repository.LocationRepository;
...
class LocationResourceIT {
    ...
    void putNewLocation() throws Exception {
        ...
        updatedLocation.streetAddress(UPDATED_STREET_ADDRESS).postalCode(UPDATED_POSTAL_CODE).city(UPDATED_CITY).country(UPDATED_COUNTRY);
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.streetAddress(UPDATED_STREET_ADDRESS).city(UPDATED_CITY).country(UPDATED_COUNTRY);
