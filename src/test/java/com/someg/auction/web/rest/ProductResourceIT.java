...
class ProductResourceIT {
    ...
    private static final Long DEFAULT_ACTUAL_COST = 1L;
    private static final Long UPDATED_ACTUAL_COST = 2L;
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getProductSpecification()).isEqualTo(DEFAULT_PRODUCT_SPECIFICATION);
        assertThat(testProduct.getActualCost()).isEqualTo(DEFAULT_ACTUAL_COST);
        assertThat(testProduct.getCcy()).isEqualTo(DEFAULT_CCY);
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].actualCost").value(hasItem(DEFAULT_ACTUAL_COST.intValue())))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.actualCost").value(DEFAULT_ACTUAL_COST.intValue()))
    ...
    void putNewProduct() throws Exception {
        ...
        assertThat(testProduct.getProductSpecification()).isEqualTo(UPDATED_PRODUCT_SPECIFICATION);
        assertThat(testProduct.getActualCost()).isEqualTo(UPDATED_ACTUAL_COST);
        assertThat(testProduct.getCcy()).isEqualTo(UPDATED_CCY);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.creationDate(UPDATED_CREATION_DATE);
